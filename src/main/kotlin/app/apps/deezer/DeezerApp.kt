...
open class DeezerApp: App() {
    ...
    protected fun searchTrackByNameAndArtist(trackName: String, artists: List<Artist>): java.util.HashMap<String, *>? {
        ...
        return artists.firstNotNullOfOrNull { artist ->
            ...
            val trackSearchURL = deezerSearchTrackURL(rawTrackName, rawArtistName)
